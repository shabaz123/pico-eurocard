...
Rev 2 - Fixes the R2 and R3 issue that Rev 1 had. Also adds connections for an SPI TFT display, and exposes I2C, GND and VSYS onto some additional pins on the edge connector for some more flexibility. Also, the 7805 regulator has a bit more space, to allow heatsinks to more easily fit.
